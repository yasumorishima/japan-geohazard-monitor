...
### 2026-06: Next frontier — nucleation from raw waveforms (both episodes complete - two honest nulls)
...
| **Nucleation (raw waveforms)** | ✅ Complete - two honest nulls (Tohoku 0/3, Kumamoto 0/3) | SeisBench PhaseNet + PyOcto micro-catalogues from continuous waveforms (Kaggle GPU); Iquique 2014 pipeline validated (4,806 events, documented foreshock migration recovered); Tohoku 2011 Hi-net episode complete - pre-registered prospective test final verdict 0/3 after detection-sensitivity equalization (matched filter; see the 2026-06 nucleation section); case 2: fully-onshore Kumamoto 2016 — 2,608-event detection-uniform micro-catalogue, pre-registered verdict 0/3: aggregate criteria do not mark the mainshock even with full array resolution |
