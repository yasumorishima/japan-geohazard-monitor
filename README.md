...
### 2026-06: Next frontier — nucleation from raw waveforms (Tohoku episode complete - honest null; case 2 Kumamoto 2016 in progress)
...
| **Nucleation (raw waveforms)** | ✅ Tohoku complete (honest null) · 🔄 Case 2 (Kumamoto 2016) running | SeisBench PhaseNet + PyOcto micro-catalogues from continuous waveforms (Kaggle GPU); Iquique 2014 pipeline validated (4,806 events, documented foreshock migration recovered); Tohoku 2011 Hi-net episode complete - pre-registered prospective test final verdict 0/3 after detection-sensitivity equalization (matched filter; see the 2026-06 nucleation section); case 2: fully-onshore Kumamoto 2016 — 50 h Hi-net window fetched (50/50 segments), pre-registered verdict fixed before picking, pipeline running |
