...
### 2026-06: Next frontier — nucleation from raw waveforms (both episodes complete - five pre-registered nulls, a sixth b-value test [retrospective asperity only], a seventh below-catalogue tremor test [0/3], and an eighth dv/v velocity-change test [0/2])
